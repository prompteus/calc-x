...
class MyDPODataCollatorWithPadding(DPODataCollatorWithPadding):
    def __call__(self, *args, **kwargs):
        ...
        # This is needed for `input_ids` to be passed to `compute_metrics``
        batch["input_ids"] = batch["prompt_input_ids"]
        return batch


class DPOTrainer(Seq2SeqTrainer):
    r"""
    ...
    def __init__(
        ...
        if data_collator is None:
            ...
            data_collator = MyDPODataCollatorWithPadding(
            ...
            if args.remove_unused_columns:
                ...
                # warn users
                warnings.warn(
                    "When using DPODataCollatorWithPadding, you should set `remove_unused_columns=False` in your Seq2SeqTrainingArguments"
    ...
    def prediction_step(
        ...
        if self.args.predict_with_generate:
            ...
            return super().prediction_step(model, supervised_inputs, prediction_loss_only, ignore_keys)
    ...
    @wraps(Seq2SeqTrainer.push_to_hub)
