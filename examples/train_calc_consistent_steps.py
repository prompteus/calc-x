...
training_args = transformers.Seq2SeqTrainingArguments(
    ...
    logging_steps=4,  # TODO: 4000 steps =~ 1 hour training, 1 hour eval, 8000 steps =~ 2 hour training, 1 hour eval
    eval_steps=4,  # TODO
    save_steps=4000,
...
trainer = transformers.Seq2SeqTrainer(
    ...
    tokenizer=tokenizer,
    data_collator=gadgets.steps_collator.StepwiseCollatorForSeq2Seq(tokenizer, step_eos_token_id=STEP_ID, model=model),
